...
<body>
	...
	<hr width: 100%; margin: auto; margin-top: 55%; margin-bottom: 55%; border-color: purple; border-height: 2px;></hr>
       ...
       <center> <h3  style="color: orange; font-size:180%" class="title2">Detalii Cos cumparaturi</h3><br>
        ...
        <div class="table-responsive">
            ...
            <tr>
                ...
                <th width="17%">Eliminare Produse din cos</th>
            </tr>
			...
			<button class="tablink" >Comanda</button>
